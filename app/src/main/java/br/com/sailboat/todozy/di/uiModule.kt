...
import br.com.sailboat.todozy.ui.history.TaskHistoryContract
import br.com.sailboat.todozy.ui.history.TaskHistoryPresenter
...
val uiModule = module {
    ...
    factory<TaskHistoryContract.Presenter> { TaskHistoryPresenter(get()) }
}