...
internal class SettingsRepositoryImplTest {
    ...
    @Test
    fun `should call setAlarmTone from data source when called from repository`() =
        runBlocking {
    ...
    @Test
    fun `should call setAlarmVibrate from data source when called from repository`() =
        runBlocking {
            prepareScenario()
    ...
    @Test
    fun `should call setDefaultAlarmTone from data source when called from repository`() =
        runBlocking {
            prepareScenario()
    ...
    @Test
    fun `should call setFirstTimeLaunchingApp from data source when called from repository`() =
        runBlocking {
            prepareScenario()
    ...
    @Test
    fun `should call getAlarmTone from data source when called from repository`() =
        runBlocking {
            val alarmTone: Uri = mockk()
    ...
    @Test
    fun `should call getAlarmVibrate from data source when called from repository`() =
        runBlocking {
    ...
    @Test
    fun `should call isFirstTimeLaunchingApp from data source when called from repository`() =
        runBlocking {
